		...
		<div class="food" v-show="showFlag" ref="food">
			<div class="food-content">
				...
				<div class="content">
					...
					<div class="price">
						<span class="now">￥{{food.price}}元</span><span v-show="food.oldPrice" class="old">￥{{food.oldPrice}}</span>
					</div>
...
<script>
	...
	export default {
		...
		data(){
			return{
				showFlag:false,
				selectType:ALL,//定义跟踪ratingselect组件的变量，传入自己的数据
				onlyContent:true,
				desc:{
					all:'全部',
					positive:'推荐',
		...
		methods:{
			...
			addFood:function(target){
				//当前组件必须在父组件 引入处，绑定 @add="xxx",继而执行 父组件的 xxx 方法
